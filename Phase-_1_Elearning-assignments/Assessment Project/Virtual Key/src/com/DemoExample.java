...
public class DemoExample {
	...
	public static void main(String[] args)throws IOException, InterruptedException 
	{
		...
		String st;
		File mFolder =new File("C:\\Users\\morea\\JavaprojectTextFile");
		mFolder.mkdir();
		String location = "C:\\Users\\morea\\JavaprojectTextFile";
		
		System.out.println("Welcome to Virtual Key!");
		System.out.println("Developer : JAishri");
	    ...
	    switch(choice) {
	    case 1:
	    	File Fobj = new File("C:\\Users\\morea\\JavaprojectTextFile");
	    ...
	    case 2:
		    ...
		    case 3:
		    	...
		    	st = sc.next();
		    	File fsearch = new File("C:\\Users\\morea\\JavaprojectTextFile");
